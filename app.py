...
# Helper to get nested secrets with fallback
...
def get_nearest_stations(lat, lon):
    ...
    if not api_key:
        ...
        return []
    api_url = (f"https://api.openchargemap.io/v3/poi/?output=json&countrycode=KE"
               f"&latitude={lat}&longitude={lon}&maxresults=10&compact=true")
